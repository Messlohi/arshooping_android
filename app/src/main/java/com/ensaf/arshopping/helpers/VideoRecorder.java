...
public class VideoRecorder {
  ...
  public  static  String pathVideoDir =  Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).toString()
          + "/ArShopping";
  ...
  public void setVideoBaseName(String videoBaseName) {
